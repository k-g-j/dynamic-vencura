...
export class AuthenticationError extends AppError {
  constructor(message: string = 'Authentication failed', code: ErrorCode = ErrorCode.UNAUTHORIZED, details?: Record<string, unknown>) {
...
export class AuthorizationError extends AppError {
  constructor(message: string = 'Access denied', code: ErrorCode = ErrorCode.FORBIDDEN, details?: Record<string, unknown>) {
...
export class BlockchainError extends AppError {
  constructor(message: string, code: ErrorCode = ErrorCode.BLOCKCHAIN_ERROR, details?: Record<string, unknown>) {
...
export class EncryptionError extends AppError {
  constructor(message: string = 'Encryption operation failed', details?: Record<string, unknown>) {
...
export class DecryptionError extends AppError {
  constructor(message: string = 'Decryption operation failed', details?: Record<string, unknown>) {
